  ...
  return (
    <section id="hero" style={{height:"100vh",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",position:"relative",zIndex:2}}>
      ...
      <div style={{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"}}>
        <div style={{position:"absolute",width:600,height:600,borderRadius:"50%",background:"radial-gradient(ellipse, rgba(26,79,196,.15), transparent 70%)",top:"10%",right:"20%",animation:"orb1 12s ease-in-out infinite",filter:"blur(40px)"}}/>
      ...
      <div style={{textAlign:"center",position:"relative",zIndex:5,padding:"0 20px",direction:"rtl"}}>
        <div style={{
          fontSize:11,fontWeight:700,letterSpacing:".4em",color:"var(--blue-accent)",textTransform:"uppercase",
        ...
        {[{text:"هندسة.", cls:"normal"},{text:"أتمتة.", cls:"stroke"},{text:"نمو.", cls:"accent"}].map((line, i) => (
          <div key={i} style={{overflow:"hidden"}}>
            <div style={{
              ...
              color: line.cls === "accent" ? "var(--blue-accent)" : line.cls === "stroke" ? "transparent" : "var(--text-primary)",
              ...
              textShadow: line.cls === "accent" ? "0 0 80px rgba(26,79,196,.5)" : "none"
            }}>
              {line.text}
            </div>
          </div>
  ...
  return (
    <section id="problem" ref={ref} style={{padding:"160px 48px",maxWidth:1400,margin:"0 auto",position:"relative",zIndex:2,direction:"rtl"}}>
      <div style={{fontSize:10,fontWeight:700,letterSpacing:".4em",color:"var(--blue-accent)",textTransform:"uppercase",marginBottom:24,display:"flex",alignItems:"center",gap:12,fontFamily:"Cairo",
        ...
        <span style={{width:30,height:1,background:"var(--blue-accent)"}}/>التحدي
      </div>
      ...
      <div className="problem-grid-inner" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:3}}>
        {cards.map((c, i) => (
          <Card3D key={i} style={{
            ...
            <div style={{position:"absolute",top:0,right:0,width:"0%",height:2,background:"var(--blue-accent)",transition:"width .6s ease",pointerEvents:"none"}} />
            <div style={{position:"absolute",inset:0,background:"radial-gradient(ellipse at 50% 0%, rgba(26,79,196,.06), transparent 60%)",opacity:0,transition:"opacity .3s",pointerEvents:"none"}}/>
...
function VisualCard1({visible}) {
  return (
    <div style={{position:"relative",height:420,opacity:visible?1:0,transform:visible?"none":"translateX(60px)",transition:"all 1.2s ease .3s"}}>
      ...
      <div style={{position:"absolute",bottom:-20,left:-20,width:180,background:"rgba(26,79,196,.07)",border:"1px solid rgba(26,79,196,.3)",borderRadius:10,padding:"20px 24px",animation:"floatA 4s ease-in-out infinite"}}>
      ...
      <div className="services-grid-inner" style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:3}}>
        {svcs.map((s, i) => (
          <Card3D key={i} style={{
            ...
            <div style={{position:"absolute",bottom:0,left:0,right:0,height:2,background:"linear-gradient(to left, #1a4fc4, transparent)",transform:"scaleX(0)",transformOrigin:"right",transition:"transform .5s ease",pointerEvents:"none"}} className="svc-line"/>
            <div style={{fontFamily:"Space Mono",fontSize:11,color:"rgba(26,79,196,.3)",letterSpacing:".2em",marginBottom:32}}>{s.n}</div>
            <div style={{width:52,height:52,background:"rgba(26,79,196,.15)",border:"1px solid rgba(26,79,196,.2)",borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,marginBottom:24,transition:"all .3s"}}>{s.icon}</div>
            ...
            <span style={{position:"absolute",bottom:36,right:36,fontFamily:"Space Mono",fontSize:16,color:"var(--blue-accent)",opacity:0,transition:"all .3s"}}>←</span>
          </Card3D>
        ))}
      </div>
    </section>
    ...
    <section id="process" ref={ref} style={{padding:"160px 48px",background:"var(--bg-primary)",overflow:"hidden",position:"relative",zIndex:2}}>
      <div style={{maxWidth:1400,margin:"0 auto",direction:"rtl"}}>
        ...
        <div className="process-steps-inner" style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:1,position:"relative"}}>
          <div style={{position:"absolute",top:36,right:"12.5%",left:"12.5%",height:1,background:"linear-gradient(to left, transparent, #1a4fc4, #00c3ff, transparent)",zIndex:0,
  ...
  return (
    <section id="cta" ref={ref} style={{padding:"160px 48px",background:"var(--bg-primary)",textAlign:"center",position:"relative",overflow:"hidden",zIndex:2}}>
      ...
      <div style={{position:"relative",zIndex:2,maxWidth:800,margin:"0 auto",direction:"rtl"}}>
        <div style={{display:"inline-flex",alignItems:"center",gap:10,background:"rgba(26,79,196,.07)",border:"1px solid rgba(26,79,196,.25)",borderRadius:99,padding:"8px 20px",fontFamily:"Cairo",fontSize:12,fontWeight:700,letterSpacing:".1em",color:"var(--blue-accent)",marginBottom:40,
