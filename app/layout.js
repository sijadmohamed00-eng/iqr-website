...
export const metadata = {
  ...
  description: "نحول فوضى مطعمك إلى دقة هندسية — نظام متكامل لإدارة الطلبات والمخزون والموظفين في العراق.",
  keywords: ["إدارة مطاعم العراق","نظام مطاعم","تطوير مطاعم بغداد","iqr"],
  ...
  openGraph: {
    ...
    url: "https://iqrhq.me", siteName: "IQR", locale: "ar_IQ", type: "website",
...
const globalStyles = `
  :root {
    --bg: #000814; --bg2: #060e22; --card: #0a1628;
    --accent: #1a4fc4; --accent2: #00c3ff;
    --text: #f0f4ff; --text2: rgba(240,244,255,.5); --text3: rgba(240,244,255,.25);
    --border: rgba(255,255,255,.06); --bronze: #cd7f32;
  }
